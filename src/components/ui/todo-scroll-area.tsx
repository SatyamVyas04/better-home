...
>(
  (
    ...
    React.useEffect(() => {
      ...
      // Run an initial check after listeners are attached.
      checkScrollability();
...
>(({ className, orientation = "vertical", ...props }, ref) => {
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      className={cn(
        "data-[state=visible]:fade-in-0 data-[state=hidden]:fade-out-0 flex translate-x-2.5 touch-none select-none p-px transition-[colors] duration-150 hover:bg-muted data-[state=hidden]:animate-out data-[state=visible]:animate-in dark:hover:bg-muted/50",
    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          showMask.left ? "before:opacity-0" : "before:opacity-0",
          showMask.right ? "after:opacity-0" : "after:opacity-0",
          "before:bg-linear-to-r before:from-card before:to-transparent",
          "after:bg-linear-to-l after:from-card after:to-transparent",
          className
        )}
        style={
          {
