        ...
        {bookmarkOptions.map((bookmark) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex w-full min-w-0 items-center gap-2.5 rounded-md border px-2 py-1.5 text-left transition-[transform,background-color,border-color,filter] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:bg-accent/30 focus-visible:bg-accent/30 focus-visible:ring-2 focus-visible:ring-ring/30 active:scale-[0.99]",
                isSelected
